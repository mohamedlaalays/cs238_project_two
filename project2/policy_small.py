...
def main():
    # SMALL
    # model = QLearning(n_states=10*10, n_actions=4, discount=0.95, learning_rate=0.001)

    model = QLearning(n_states=500*100, n_actions=9, discount=1, learning_rate=0.001)
